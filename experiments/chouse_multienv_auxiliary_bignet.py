...
from experiments.ai2_auxiliary.model import BigGoalModelWithAuxiliary
...
class Trainer(AuxiliaryTrainer):
    ...
    def create_model(self):
        return BigGoalModelWithAuxiliary(self.env.observation_space.spaces[0].spaces[0].shape[0], self.env.action_space.n)
