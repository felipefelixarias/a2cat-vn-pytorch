...
from models import AuxiliaryBigModel as Model
...
@register_trainer(max_time_steps = 2.5e6, validation_period = None, validation_episodes = None,  episode_log_interval = 10, saving_period = 100000, save = True)
class Trainer(AuxiliaryTrainer):
    ...
    def create_model(self):
        ...
        model = Model(3, self.env.action_space.n, 4, True)
        return model
