...
import gym.spaces
import numpy as np
from gym_minos.envs.env import MinosEnv as MinosEmulator
import cv2
import random

class WrappedMinos(gym.Env):
    def __init__(self, configuration, screen_size = (224, 224,)):
        self.env = MinosEmulator()


class MinosEnv(gym.Env):
    def __init__(self, scenes, screen_size = (224, 224)):
        configuration()
