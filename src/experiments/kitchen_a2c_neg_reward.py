...
register_agent('kitchen-a2c-neg-reward')(A2CAgent)
@register_trainer('kitchen-a2c-neg-reward', max_time_steps = 1000000, validation_period = 100,  episode_log_interval = 10, saving_period = 10000)
