...
from a2c.a2c_gradient_accumulation import A2CTrainer, A2CAgent
import numpy as np
...
register_agent('test-a2c-grad-accum')(A2CAgent)
@register_trainer('test-a2c-grad-accum', max_time_steps = 100000000, validation_period = 1000,  episode_log_interval = 100, saving_period = 500000)
