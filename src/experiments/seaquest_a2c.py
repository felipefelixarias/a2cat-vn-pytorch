...
register_agent('seaquest-a2c')(A2CAgent)
@register_trainer('seaquest-a2c', max_time_steps = 10e6, validation_period = 100,  episode_log_interval = 10, saving_period = 500000)
...
def default_args():
    return dict(
        env_kwargs = lambda: wrap_deepmind(make_atari('SeaquestNoFrameskip-v4'), scale=True),
